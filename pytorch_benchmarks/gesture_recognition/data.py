...
def get_data(data_dir=None,
    ...
    ds = DB6MultiSession(folder=data_dir, subjects=subjects, sessions=train_sessions, steady=True, n_classes='7+1', minmax=True, image_like_shape=True)
    test_ds = DB6MultiSession(folder=data_dir, subjects=subjects, sessions=test_sessions, steady=True, n_classes='7+1',  minmax=(ds.X_min, ds.X_max), image_like_shape=True)
